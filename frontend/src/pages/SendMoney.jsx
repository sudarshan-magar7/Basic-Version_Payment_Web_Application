...
export const SendMoney = () => {
    ...
    useEffect(() => {
        console.log("Updated amount:", amount); // Logs every time `amount` changes
    }, [amount]);
    ...
    console.log(name);
    const to = searchParams.get('user_id');
    console.log(to);
            ...
            >
                ...
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <button onClick={()=>{
                            axios.post('http://localhost:8081/v1/api/account/transfer',{
                                amount,
                                to
                            },{
                                headers: {
